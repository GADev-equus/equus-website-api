...
analyticsSchema.statics.getPageViews = async function (
  startDate,
  endDate,
  filters = {},
) {
...
analyticsSchema.statics.getUniqueVisitors = function (
  startDate,
  endDate,
  filters = {},
) {
...
analyticsSchema.statics.getTopPages = function (
  startDate,
  endDate,
  limit = 10,
) {
...
analyticsSchema.statics.getTrafficByPeriod = function (
  startDate,
  endDate,
  granularity = 'daily',
) {
